...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_-8ceCxnD.mjs';
import { manifest } from './manifest_C8r4cxxo.mjs';
...
const _page7 = () => import('./pages/products.astro.mjs');
const _page8 = () => import('./pages/reviews.astro.mjs');
const _page9 = () => import('./pages/sitemap.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/products.astro", _page7],
    ["src/pages/reviews.astro", _page8],
    ["src/pages/sitemap.astro", _page9],
...
const _args = {
    "middlewareSecret": "4dfd2181-f996-414f-b784-3f6500ccf9a8",
