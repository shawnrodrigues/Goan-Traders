...
const MIN_SUBMIT_TIME_MS = 4e3;
const DUPLICATE_WINDOW_MS = 24 * 60 * 60 * 1e3;
...
const ALLOWED_QUANTITY_UNITS = /* @__PURE__ */ new Set(["bags", "tons", "kg", "liters", "truckloads", "custom"]);
const CORS_HEADERS = {
...
const duplicateSubmissionStore = /* @__PURE__ */ new Map();
function sanitizeInput(input) {
  if (!input) return "";
  return input.toString().trim().replace(/[<>\"'&]/g, "").substring(0, MAX_FIELD_LENGTH);
}
      ...
      embeds: [
        {
          ...
          footer: {
            text: `🕐 IST: ${(/* @__PURE__ */ new Date()).toLocaleString("en-IN", { timeZone: "Asia/Kolkata" })}`
          },
