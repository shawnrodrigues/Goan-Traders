export const products = [
  // -------------------------- JK Products ----------------------------
  {
    ...
    image: '/media/JK-Super-Strong.png',
  ...
  },
  {
    ...
    image: '/media/JK-Super-Cemnt-PSC.png',
  ...
  },
  {
    ...
    image: '/media/JK-Super-Cement-PPC.png',
  ...
  },
  {
    ...
    image: '/media/JK-Super-Cement-OPC-43-Grade.png',
  ...
  // -------------------------- UltraTech Products ----------------------------
  {
    ...
    image: '/media/UltraTech-Cement.png',
  ...
  },
  {
    ...
    image: '/media/UltraTech-Cememt-Weather-Plus.png',
...

  {
    ...
    image: '/media/UltraTech-Weather-Pro.jpeg',
...

  {
    ...
    description: 'A versatile SBR latex-based chemical for high-performance waterproofing, repairing, and bonding of concrete and masonry structures.',
    image: '/media/UltraTech-Seal&Dry.jpg',
    alt: 'UltraTech Seal & Dry waterproofing chemical for sale in Nuvem, Goa',
    badge: { text: 'Waterproofing', class: '' },
    specs: { 
      'Type': 'SBR Latex', 
      'Coverage': 'Approx. 20-22 sq.ft./kg in 2 coats', 
      'Pack Size': '1kg, 5kg, 20kg', 
      'Applications': 'Roofs, bathrooms, repair work, bonding agent' 
    },
    features: ['High Flexibility', 'Excellent Adhesion', 'Prevents Cracking'],
    rating: 4.5,
    ratingText: '4.8/5'
  },
...

  {
    ...
    image: '/media/Ramco-43-Grade.png',
...

  {
    ...
    image: '/media/Ramco-53-Grade.png',
...

  {
    ...
    image: '/media/Ramco-Supercrete-Cement.jpg',
...

  {
    ...
    image: '/media/Ramco-Super-Grade.jpg',
...

  {
    ...
    image: '/media/Ramco-Infra-43-Grade.png',
...

  {
    ...
    image: '/media/Ramco-Infra-53-Grade.png',
...

  {
    ...
    image: '/media/Ramco-Tile-Fix.png',
...

  {
    ...
    image: '/media/Ramco-Super-Shield.jpg',
...

  {
    ...
    image: '/media/JSW-Cement-Power-PRO.png',
...

  {
    ...
    image: '/media/JSW-Cement-Compcem.png',
  ...
  // -------------------------- chemicals ----------------------------
    ...
    image: '/media/Ramco-Super-Plaster-Eco.png',
...

{
  ...
  specs: { 
    ...
    'Size': '8" x 4" x 4" (Standard)',
    'Applications': 'Load-bearing walls, foundations, general masonry' 
  },
  features: ['High Compressive Strength', 'Uniform Shape', 'Durable Construction'],
  rating: 4.5,
  ratingText: '4.6/5'
},

{
  ...
  description: 'Lightweight and durable hollow blocks, ideal for creating partition walls and non-load-bearing structures with excellent thermal insulation.',
  image: '/media/Concrete-Blocks.jpg',
  alt: 'Stack of hollow concrete blocks for partition walls in Goa',
  badge: { text: 'Lightweight', class: '' },
  specs: { 
    'Type': 'Hollow Concrete Block', 
    'Size': '16" x 8" x 8" (Standard)',  
    'Applications': 'Partition walls, infill masonry, non-load-bearing structures' 
  },
  features: ['Lightweight', 'Thermal Insulation', 'Faster Construction'],
  rating: 4.5,
  ratingText: '4.5/5'
},

{
  ...
  description: 'Traditional, high-quality burnt clay bricks, perfect for masonry, retaining walls, and aesthetic exterior applications requiring a classic look.',
  image: '/media/Bricks-(Brown).jpg',
  alt: 'Pile of brown clay bricks for construction in Nuvem, Goa',
  badge: { text: 'Classic', class: '' },
  specs: { 
    'Type': 'Burnt Clay Brick', 
    'Size': '9" x 4" x 3" (Standard)', 
    'Applications': 'Walls, foundations, paving, architectural elements' 
  },
  features: ['Classic Appearance', 'High Durability', 'Good Thermal Mass'],
  rating: 4.5,
  ratingText: '4.7/5'
},

{
  ...
  brand: 'Building Materials',
  category: 'building-materials',
  name: 'Fly Ash Bricks (Grey/Black)',
  description: 'Eco-friendly and high-strength fly ash bricks, known for their uniform shape and smooth finish. An excellent choice for modern construction.',
  image: '/media/Bricks-(Black).jpg',
  alt: 'Stack of grey fly ash bricks for sale in Nuvem, Goa',
  badge: { text: 'Modern Look', class: '' },
  specs: { 
    'Type': 'Fly Ash Brick', 
    'Size': '9" x 4" x 3" (Standard)', 
    'Strength': '10+ MPa', 
    'Applications': 'Load-bearing & non-load-bearing walls, masonry work' 
  },
  features: ['Uniform Shape', 'High Compressive Strength', 'Lower Water Absorption'],
  rating: 4.5,
  ratingText: '4.8/5'
},

{
  id: 'red-laterite-stone',
  brand: 'Building Materials',
  category: 'building-materials',
  name: 'Red Laterite Stone',
  description: 'Locally sourced Goan laterite stone, known for its unique porous texture and earthy red color. Ideal for creating durable, breathable walls and traditional architectural features.',
  image: '/media/Red-Laterite-Stone.jpg',
  alt: 'Stack of red laterite stone blocks for sale in Nuvem, Goa',
  badge: { text: 'Goan Tradition', class: '' },
  specs: { 
    'Type': 'Laterite Stone Block', 
    'Size': '14" x 8" x 8" (Approx.)', 
    'Finish': 'Rough Cut', 
    'Applications': 'Compound walls, foundations, architectural masonry' 
  },
  features: ['Natural Material', 'Excellent Insulation', 'Porous & Breathable'],
  rating: 4.5,
  ratingText: '4.8/5'
},

{
  id: 'crushed-sand-m-sand',
  brand: 'Building Materials',
  category: 'building-materials',
  name: 'Sand',
  description: 'High-quality manufactured sand produced from crushed rock, an excellent and sustainable alternative to river sand for concrete work.',
  image: '/media/sand.jpeg',
  alt: 'Crushed sand (M Sand) for construction in Goa',
  badge: null,
  specs: { 'Type': 'Crushed Sand / M Sand', 'Unit': 'Per Ton', 'Applications': 'Concrete mix, blockwork, general construction' },
  features: ['High Strength Concrete', 'Consistent Quality', 'Eco-Friendly Alternative'],
  rating: 4.5,
  ratingText: '4.6/5'
},

{
  id: 'kadi-granite-aggregate',
  brand: 'Building Materials',
  category: 'building-materials',
  name: 'Kadi (Granite Aggregate)',
  description: 'High-quality crushed granite stone (Kadi), essential for producing strong and durable concrete for foundations, beams, and slabs.',
  image: '/media/Kadi.jpeg',
  alt: 'Pile of Kadi granite aggregate for concrete mix in Goa',
  badge: { text: '', class: '' },
  specs: { 
    'Type': 'Granite Aggregate', 
    'Size': '20mm (Standard)', 
    'Unit': 'Per Ton', 
    'Applications': 'Reinforced concrete, foundations, slabs, roads' 
  },
  features: ['High Compressive Strength', 'Proper Gradation', 'Foundation of Concrete'],
  rating: 4.5,
  ratingText: '4.7/5'
},
];